...
@section('content')
    ...
    <section class="container-admin">
        ...
        <section class="form-content-area">
            ...
            <div class="form-content-wrapper">
                <div class="btn-area-estados">
                    <a href="{{ route('adm.tipo-imovel.create') }}" title="Cadastrar">Cadastrar <i class="icon-plus"></i></a>
                </div>
                <div class="admin-table" style="position: relative">
                    ...
                    <table>
                        <div class="search-box">
                            ...
                            <input type="text" id="filter" onkeyup="getFilter(this.value, '{{ route('adm.tipo-imovel.ajax') }}')" placeholder="Pesquisa">
                        </div>
                        <thead>
                        <tr>
                            <th>Tipos de imóveis</th>
                            <th></th>
                            <th></th>
                            <th></th>
                        </tr>
        ...
        <script>
            const titlePage = new admTitlePage("Tipo de imóvel", "Visualize os tipos de imóveis, clique em <i class='icon-plus'></i> para adicionar, <i class='icon-eye'></i> para visualizar e <i class='icon-trash'></i> para apagar.");
                            ...
                            Object.values(responseJson).map((data)=>(
                                table.innerHTML += `
                                   <tr>
                                       ...
                                       <td>
                                           <div class="btn-area">
                                               <a href="{{ url('/admin/tipo-imovel/edit/') }}/${data.id}"><i class="icon-pencil"></i> Editar</a>
                                               <button type="button" id="deleteRow" onclick="openModal('{{ url('/admin/tipo-imovel/delete/') }}', ${data.id}, '{{ route('adm.tipo-imovel.all') }}')"><i class='icon-trash'></i>Apagar</button>
                                           </div>
                                       </td>
                                   </tr>
                               `
            ...
            getData("{{ route('adm.tipo-imovel.all') }}")
        </script>
    </section>
