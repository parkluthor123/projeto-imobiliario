    ...
    <section class="container-admin">
        ...
        <section class="form-content-area">
            ...
            <div class="form-content-wrapper">
                <form action="{{ url('/admin/tipo-imovel/update/')."/".$tipo['id'] }}" method="POST">
                    @csrf
                    <div class="form-item">
                        <label for="tipo-imovel">Tipo de Imóvel</label>
                        <input type="text" value="{{ $tipo['tipo'] }}" required placeholder="Digite o tipo de imóvel" id="tipo-imovel" name="tipo_imovel">
                    </div>
                    <div class="btn-area">
        ...
        <script>
            const titlePage = new admTitlePage("Tipo de imóvel", "Você pode editar um tipo de imóvel existente. Insira os dados no formulário abaixo e clique em salvar.");
