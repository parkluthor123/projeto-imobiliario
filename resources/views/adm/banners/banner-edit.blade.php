...
@section('content')
        ...
        <section class="form-content-area">
            ...
            <div class="form-content-wrapper">
                ...
                <fieldset data-fieldset="Descrição do banner">
                    <div class="form-item">
                        <input type="text" value="{{ $banner['description'] }}" onkeyup="data.descricao = this.value;" placeholder="Digite a descrição do banner" name="descricao" maxlength="40" id="descricao">
                ...
                <fieldset data-fieldset="Link do banner">
                    <div class="form-item">
                        <input type="text" value="{{ $banner['link'] }}" onkeyup="data.link = this.value;" placeholder="Digite o link do banner" name="link" id="link">
                    </div>
                </fieldset>
                <br>
                <br>
    ...
    <script>
        ...
        saveImage.addEventListener("click", async function(){
            ...
            {
                await fetch("{{ url('/admin/banner/update/')."/".$banner['id'] }}", {
                    method: 'POST',
                    headers: {
