    ...
    <section class="container-admin">
        ...
        <section class="form-content-area">
            ...
            <div class="form-content-wrapper">
                <form action="{{ url('/admin/ajustes/configuracoes-usuarios/update/')."/". $users['id'] }}" method="POST">
                    @csrf
                    <div class="form-item">
                        <label for="nome">Nome</label>
                        <input value="{{ $users['name'] }}" type="text" required placeholder="Digite o nome" name="name" id="name">
                    </div>
                    <div class="form-item">
                        <label for="email">E-mail</label>
                        <input type="text" value="{{ $users['email'] }}" required placeholder="Digite o email" name="email" id="email">
                    </div>
                    <div class="form-item">
                    ...
                    <div class="form-item">
                        ...
                        <input type="password" placeholder="Confirmar senha" name="conf_senha" id="conf_senha">
                    </div>
                    <div class="btn-area">
