    ...
    <section class="container-admin">
        ...
        <section class="form-content-area">
            ...
            <div class="form-content-wrapper">
                <form action="{{ route('adm.localidades.bairros.store') }}" method="POST">
                    @csrf
                    <div class="form-item">
                        <label for="estado">Bairros</label>
                        <input type="text" value="{{ old('bairros') }}" required placeholder="Digite o bairro" id="bairros" name="bairros">
                    </div>
                    <br>
                    <br>
        ...
        <script>
            const titlePage = new admTitlePage("Bairros", "Você pode cadastrar um novo bairro. Insira os dados no formulário abaixo e clique em salvar.");
