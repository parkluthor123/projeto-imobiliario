...
@section('content')
    ...
    <section class="container-admin">
        ...
        <section class="form-content-area">
            ...
            <div class="form-content-wrapper">
                <form action="{{ route('adm.vender.store') }}" method="POST">
                    @csrf
                    <div class="form-item">
                    ...
                    <div class="form-wrapp">
                        <div class="form-item">
                            ...
                            <input type="text" value="{{ old('cep') }}" required placeholder="Digite o bairro" id="bairro" name="bairro">
                        </div>
                        <div class="form-item">
    ...
    <script>
        const titlePage = new admTitlePage("Vender", "Você pode cadastrar uma nova nova solicitação de venda. Insira os dados no formulário abaixo e clique em salvar.")
